  ...
  return (
    <Card className="tour rounded p-3">
      ...
      <Card.Body className="tour-info">
        <Card.Title className="mb-2 text-danger bg-white p-1">
          {tour.city}
        </Card.Title>
        <Card.Subtitle className="mb-2 text-white bg-danger p-1">
          {tour.name}
        </Card.Subtitle>
        <Card.Text className="para">{showInfo && <p>{tour.info}</p>}</Card.Text>
